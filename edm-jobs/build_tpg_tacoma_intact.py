import os, runpy
# Canonical FBX-derived Tacoma intact export. One source-mesh body pass plus bounded V32 visual validation.
...
runpy.run_path("edm-jobs/build_tpg_tacoma_hero_silhouette_v32.py", run_name="__main__")

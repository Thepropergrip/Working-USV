...
# shell generated by build_tpg_tacoma.py with a photo-matched Tacoma shell.
...
print("[TPG TACOMA HERO V5] Flattened ARE-style topper roof and photo-matched side/rear glazing")

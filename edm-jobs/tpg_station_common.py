...
def mats():
    if MATS:
        return MATS
    MATS.update({
        "asphalt": edm_mat("TPG_GASPRO_Asphalt",(0.115,0.122,0.126),0.95,0.0,0.065,True),
        "concrete": edm_mat("TPG_GASPRO_Concrete",(0.49,0.495,0.475),0.90,0.0,0.050,True),
        "stucco": edm_mat("TPG_GASPRO_Stucco",(0.70,0.665,0.585),0.84,0.0,0.038,True),
        "white": edm_mat("TPG_GASPRO_PaintedWhite",(0.79,0.80,0.77),0.58,0.02,0.022),
        "red": edm_mat("TPG_GASPRO_BrandRed",(0.44,0.026,0.020),0.43,0.08,0.020),
        "charcoal": edm_mat("TPG_GASPRO_Charcoal",(0.050,0.055,0.060),0.56,0.04,0.018),
        "metal": edm_mat("TPG_GASPRO_Metal",(0.30,0.315,0.325),0.31,0.74,0.020),
        "aluminum": edm_mat("TPG_GASPRO_Aluminum",(0.49,0.50,0.50),0.28,0.82,0.018),
        "glass": edm_mat("TPG_GASPRO_Glass",(0.050,0.115,0.145),0.18,0.10,0.010),
        "rubber": edm_mat("TPG_GASPRO_Rubber",(0.018,0.020,0.021),0.94,0.0,0.015),
        "screen": edm_mat("TPG_GASPRO_Screen",(0.025,0.055,0.044),0.26,0.05,0.008),
        "yellow": edm_mat("TPG_GASPRO_SafetyYellow",(0.72,0.49,0.035),0.64,0.02,0.025),
        "blue": edm_mat("TPG_GASPRO_StickerBlue",(0.035,0.22,0.42),0.52,0.02,0.015),
        "green": edm_mat("TPG_GASPRO_StickerGreen",(0.045,0.36,0.13),0.56,0.01,0.015),
        "orange": edm_mat("TPG_GASPRO_StickerOrange",(0.82,0.26,0.025),0.55,0.01,0.018),
        "cream": edm_mat("TPG_GASPRO_Cream",(0.88,0.82,0.66),0.66,0.0,0.020),
        "interior": edm_mat("TPG_GASPRO_InteriorDark",(0.075,0.070,0.060),0.78,0.01,0.020),
    })
    return MATS
